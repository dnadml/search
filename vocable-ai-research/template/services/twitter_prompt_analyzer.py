...
def get_query_gen_prompt(prompt, is_accuracy=True):
    ...
    """
    logging.info("get_query_gen_prompt Start   ============================")
    logging.info(content)
    logging.info("get_query_gen_prompt End   ==============================")
    return content
...
class TwitterPromptAnalyzer:
    ...
    async def generate_query_params_from_prompt(self, prompt, is_accuracy=True):
        ...
        logging.info("generate_query_params_from_prompt Content: ", response_dict)
    ...
    async def analyse_prompt_and_fetch_tweets(self, prompt, is_recent_tweets=True):
        ...
        try:
            ...
            logging.info(f"Tweets fetched amount ============= {tweets_amount}")

            return result_json, prompt_analysis
        except Exception as e:
            logging.error(f"analyse_prompt_and_fetch_tweets, {e}")
...
if __name__ == "__main__":
    ...
    result = asyncio.run(client.analyse_prompt_and_fetch_tweets("What is Artifical Intelligence"))
    print(result)
